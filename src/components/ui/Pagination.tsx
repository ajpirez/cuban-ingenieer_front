                        ...
                        href={createPageUrl(currentPage - 1)}><IoChevronBackOutline size={30}/></a></li>
                    {
                        allPages.map(((page, index) => (
                            <li key={page + '_' + index}
                                ...
                                <Link
                                    className={
                                        clsx('page-link relative block py-1.5 px-3 border-0  outline-none transition-all duration-300 rounded  hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md',
                                            {
